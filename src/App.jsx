      ...
      <main className="max-w-2xl mx-auto px-5 sm:px-6 py-8 sm:py-12 pt-[env(safe-area-inset-top)] space-y-7 sm:space-y-16 relative z-10 pb-20 safe-bottom">
        ...
        <motion.section className="text-center space-y-6 sm:space-y-8" {...(isMobile ? sectionVisible : fadeInUp)}>
          ...
          <div className="space-y-2 relative">
            <span className="float-emoji absolute -left-2 top-0 text-xl opacity-60" style={{ animationDelay: '0s' }} aria-hidden>🦋</span>
          ...
          <p className="text-2xl sm:text-3xl flex justify-center gap-2 items-center">
            <span className="float-emoji text-amber-300/90" style={{ animationDelay: '0s' }} aria-hidden>✨</span>
            <span className="float-emoji text-base opacity-80" style={{ animationDelay: '0.5s' }} aria-hidden>🦋</span>
            <span className="float-emoji text-amber-200/90" style={{ animationDelay: '0.2s' }} aria-hidden>🌹</span>
            <span className="float-emoji text-amber-300/90" style={{ animationDelay: '0.4s' }} aria-hidden>✨</span>
          </p>
        </motion.section>
        ...
        <motion.section className="rounded-2xl p-6 sm:p-8 card-glass card-hover card-breath card-gradient-border" {...(isMobile ? sectionVisible : fadeInUp)}>
          <div className="section-header flex flex-col items-center mb-6">
            <h2 className="text-xl sm:text-2xl font-display font-semibold text-rose-50 text-center">
              ❤️ Coisas que amo em você <span className="float-emoji text-lg ml-1" style={{ animationDelay: '0.5s' }} aria-hidden>🦋</span>
            </h2>
          </div>
        ...
        <motion.section className="text-center py-12 sm:py-16 relative" {...(isMobile ? sectionVisible : fadeInUp)}>
          ...
          <div className="text-4xl sm:text-5xl mb-4 flex justify-center gap-2">
            ...
            <span className="float-emoji" style={{ animationDelay: '0.5s' }} aria-hidden>❤️</span>
            <span className="float-emoji" style={{ animationDelay: '1s' }} aria-hidden>💗</span>
          </div>
          ...
          <p className="text-amber-200/90 mt-6 text-base sm:text-lg flex items-center justify-center gap-2 flex-wrap">
            <span>🌹</span> Sempre contigo, amor <span className="float-emoji inline-block text-sm" style={{ animationDelay: '0.3s' }} aria-hidden>🦋</span> <span>🌹</span>
          </p>
