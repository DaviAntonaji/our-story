...
export const CONQUISTAS = [
  // ── Desbloqueadas ─────────────────────────────────────────────────────────
  {
    ...
    subtitulo: 'A mensagem que salvou tudo - obrigado, mãe da Maysa',
    descricao: 'Duas tentativas ignoradas antes. Na terceira, a mãe da Maysa disse pra ela responder por educação pelo menos. Aquela resposta simples mudou o rumo de tudo.',
    icon: '💬',
    raridade: 'comum',
  ...
  },
  {
    ...
    subtitulo: 'Ela se apaixonou sem nem perceber',
    descricao: 'Num dia difícil em que ela estava muito mal, ele falou sobre Deus, sobre não desanimar. Ela chorou - e foi só depois, namorando, que contou: foi ali que se apaixonou.',
    icon: '💕',
    raridade: 'especial',
  ...
  },
  {
    ...
    descricao: 'Planejado em cada detalhe: mesa separada, garçom no plano, buquê chegando na hora certa. Olhos brilhando, bochecha tremendo de alegria - naquele instante ele se tornou o homem mais feliz do mundo.',
    icon: '💍',
    raridade: 'epico',
  ...
  },
  {
    ...
    descricao: 'Na mesma noite em que os pais dela autorizaram o namoro. Torta de frango incrível, o som de "Aquilo que Parecia Impossível" no aniversário do Wagner - e o primeiro beijo.',
    icon: '🌹',
    raridade: 'epico',
  ...
  },
  {
    ...
    descricao: 'Ela chamou às 11h, ele estava lá às 12h. Tarde na represa, vôlei, giros de princesa na água - o tipo de dia simples que fica pra sempre.',
    icon: '🌊',
    raridade: 'especial',
  ...
  },
  {
    ...
    subtitulo: 'Primeiro pós-culto com os pais dela',
  ...
  },
  {
    ...
    descricao: 'Pipoca de microondas, refri, fini e brigadeiro absurdo de bom que ele sumiu em segundos. Filme lindo, irmãs fazendo festa do pijama, beijinhos - do jeitinho que a gente é.',
    icon: '🎥',
    raridade: 'comum',
  ...
  },
  {
    ...
    descricao: 'Troca de presentes na praça: flores, cartinha manuscrita, docinhos e o anel solitário no fundo da caixinha. Ela deu um potinho cheio de beijinhos marcados. Dois meses que parecem muito mais.',
    icon: '💍',
    raridade: 'lendario',
  ...
  {
    id: 'c16',
    titulo: 'Primeiro Aniversário Dela',
    subtitulo: 'Colar "Para minha futura esposa" + 1ª videochamada',
    descricao: 'Parabéns às 00:00 em ponto. Colar com promessa, brincos, corrida de carro pra não perder o ônibus, e a primeira videochamada de todas - dormiram em ligação pela primeira vez.',
    icon: '🎂',
    raridade: 'epico',
  ...
  {
    id: 'c17',
    titulo: 'Primeira Moto Juntos',
    subtitulo: 'Carreta Furacão - improvisado e inesquecível',
    descricao: 'Quase não foram. No último dia, no último horário - andaram de moto juntos pela primeira vez. A primeira vez dela no trenzinho. Rindo de tudo, completamente felizes.',
    icon: '🎡',
    raridade: 'comum',
  ...
  },
  {
    ...
    descricao: 'Tias, família do pai, canjica e bolo - e depois a noite ficou tensa quando a irmã dele passou mal. Ela ficou. O ajudou a respirar, a orar, a manter a cabeça no lugar. Ela foi abrigo.',
    icon: '👨‍👩‍👧',
    raridade: 'especial',
  ...
  },
  {
    ...
    subtitulo: 'Ela enfrentou o medo e conseguiu',
    descricao: 'Com medo, mas corajosa. Fórum, lugar vazio, ele guiando com cuidado. Ela colocou o carro em movimento, foi virando devagar - e conseguiu. Orgulho que não cabe no peito.',
    icon: '🚗',
    raridade: 'especial',
  ...
  },
  {
    ...
    descricao: 'No aniversário dela, a primeira videochamada de todas - ela foi mostrando o quarto, comendo alguma coisa, trocando de roupa, se ajeitando pra dormir. Dormiram em ligação. Ele apagou primeiro kkk.',
    icon: '📱',
    raridade: 'comum',
    data: '07 de mai de 2026',
    desbloqueada: true,
  },
  {
    ...
    descricao: 'Ela deu um livrinho feito a mão no primeiro pós-culto, e ele deu a primeira cartinha manuscrita no 2º mêsversário. Dois corações que preferem escrever do que guardar só pra si.',
    icon: '💌',
    raridade: 'comum',
    desbloqueada: true,
  },
