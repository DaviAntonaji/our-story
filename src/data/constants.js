...
export const SLIDE_IDS = [
  ...
  'historia', 'mapa',
  'presentefotos',
  'promessas', 'motivos', 'futuro', 'recado', 'creditos', 'cartas', 'bucketlist', 'final',
]
...
export const MAPA_LUGARES = [
  ...
  {
    id: 'casa-pais-dela',
    nome: 'Casa dos pais dela',
    icon: '🏠',
    categoria: 'Onde tudo foi autorizado',
    coords: [-22.282127, -51.488433],
    foto: '/imgs/photos/conversa_com_seus_pais/10.jpeg',
    data: '07 de março de 2026',
    descricao: 'A noite da conversa com seus pais, torta de frango incrível, nossa autorização para namorar de verdade — e nosso primeiro beijo. Um dos dias mais marcantes da nossa história.',
  },
  {
    id: 'tips-lanches',
    nome: 'Tips Lanches',
  ...
  {
    id: 'avos-dela',
    nome: 'Casa dos avós dela',
    icon: '👨‍👩‍👧',
    categoria: 'Em família',
    coords: [-22.282073, -51.487556],
    foto: '/imgs/photos/almoco_nos_seus_avos/33.jpg',
    data: '22 de março de 2026',
    descricao: 'Almoço em família que foi divertido, engraçado e cheio de alegria. Comida boa, boas risadas — exatamente o tipo de dia que faz tudo valer a pena.',
  },
  {
    id: 'minha-casa',
    nome: 'Minha casa',
    icon: '🎥',
    categoria: 'Tardes de filme',
    coords: [-22.274964, -51.509402],
    foto: '/imgs/photos/sabado_de_filme_na_minha_casa/IMG_3061.jpg',
    data: 'Março e abril de 2026',
    descricao: 'Sua primeira visita, café da tarde com meus pais, e depois noites de filme com pipoca, brigadeiro e nossas irmãs fazendo festa do pijama no fundo. O tipo de tarde simples que a gente ama.',
  },
  {
    id: 'cafeteria-koike',
